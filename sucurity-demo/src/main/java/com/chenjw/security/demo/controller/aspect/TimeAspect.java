package com.chenjw.security.demo.controller.aspect;
...
public class TimeAspect {
    ...
    /**
     * 作用范围，第一个*表示任意返回值，后边紧跟范围com.chenjw.security.demo.controller.UserController中任意接口，最后的（..）表示任意参数
     *
     * @throws Throwable
     */
//	@Around("execution(* com.chenjw.security.demo.controller.*(..))")
